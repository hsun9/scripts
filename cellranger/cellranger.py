...
def Main():
    ...
    if args.table != '':
        CallSeqCount_MultipleSamples(f_bsub, args.pipeline, f_config, script, args.table, outdir)
    else:
        CallSeqCount_SingleSample(f_bsub, args.pipeline, f_config, script, args.ref, args.name, args.fdir, outdir)
